...
package com.fuusy.navigationremake.navi;
...
import com.fuusy.navigationremake.R;
...
public class FragmentNavigator extends Navigator<FragmentNavigator.Destination> {
    ...
    public boolean popBackStack() {
        ...
        if (mBackStack.isEmpty()) {
            Log.d(TAG, "popBackStack: isEmpty");
            return false;
        }
...
//            Log.d(TAG, "navigate: hide fragment " + fragment.getTag());
...
//        }
        ...
        newPrimaryFragment = mFragmentManager.findFragmentByTag(tag);

        if (newPrimaryFragment == null) {
            newPrimaryFragment = instantiateFragment(mContext, mFragmentManager, className, args);
            ...
            fragmentTransaction.add(mContainerId, newPrimaryFragment, tag);
